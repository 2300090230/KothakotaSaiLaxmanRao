  ...
  const fetchDashboardStats = async () => {
    try {
      ...
      const [skillsResponse, certificationsResponse, projectsResponse, messagesResponse] = await Promise.allSettled([
        axios.get(`${config.url}/skills/countskills`, { timeout: 10000 }),
        axios.get(`${config.url}/certifications/countcertifications`, { timeout: 10000 }),
        axios.get(`${config.url}/projects/countprojects`, { timeout: 10000 }),
        axios.get(`${config.url}/contacts/countmessages`, { timeout: 10000 })
      ]);
